...
- the move similarly, though $m1$ seems to be higher than $m2$
- they are very much related (functionally) 
  - though there is some scatter around the regression line, it is small
- they do seem mostly proxy for each other, neither adding much information to
  the other.
